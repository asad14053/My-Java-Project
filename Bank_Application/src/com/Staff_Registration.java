...
public class Staff_Registration extends javax.swing.JDialog {

    Connection conn = null;
    OraclePreparedStatement pst = null;
    OracleResultSet rs = null;

    public Staff_Registration(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Fill In The Form For Staff Registration", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14), new java.awt.Color(255, 102, 0))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Employee Rank", "Director", "General Manager", "Assistant General manager", " ", " ", " " }));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jButton11, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(29, 29, 29)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try {
            ...
            String sq1 = "insert into st_reg(name,id,address,rank,basc_salary,sex,password,acc_num,dob) values(?,?,?,?,?,?,?,?,?)";
            ...
            pst.setString(6, jComboBox5.getSelectedItem().toString());
            pst.setString(7, jPasswordField1.getText());
            pst.setString(8, jTextField5.getText());
            pst.setTimestamp(9, new java.sql.Timestamp(jDateChooser2.getDate().getTime()));

            int status = pst.executeUpdate();
            if (status > 0) {
                JOptionPane.showMessageDialog(null, "Thanks for registration");
            } else {
                JOptionPane.showMessageDialog(null, "The username and password is successfully verified");
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Staff_Registration dialog = new Staff_Registration(new javax.swing.JFrame(), true);
